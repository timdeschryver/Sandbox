...
namespace Sandbox.Migrations.Migrations
{
    ...
    [Migration("20251206130814_LowercaseObjects")]
    partial class LowercaseObjects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sandbox.Modules.CustomerManagement.Domain.Customer", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Name", "Sandbox.Modules.CustomerManagement.Domain.Customer.Name#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Sandbox.Modules.CustomerManagement.Domain.CustomerAddress", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Address", "Sandbox.Modules.CustomerManagement.Domain.CustomerAddress.Address#Address", b1 =>
                        {
                            b1.IsRequired();
